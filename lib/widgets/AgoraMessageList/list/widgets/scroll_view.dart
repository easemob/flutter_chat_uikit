...
/// argument. The [ExtendedListView.builder] constructor's `itemBuilder` and
...
class ExtendedListView extends BoxScrollView {
  ...
  /// [ExtendedListView] itself is created, it is more efficient to use [ListView].
...
///
/// The [GridView], [ExtendedGridView.count], and [ExtendedGridView.extent]
/// constructors' `children` arguments correspond to the [childrenDelegate]
/// being a [SliverChildListDelegate] with that same argument. The [GridView.builder]
/// constructor's `itemBuilder` and `childCount` arguments
/// correspond to the [childrenDelegate] being a [SliverChildBuilderDelegate]
/// with the matching arguments.
///
/// The [ExtendedGridView.count] and [ExtendedGridView.extent] constructors create
/// custom grid delegates, and have equivalently named constructors on
/// [SliverGrid] to ease the transition: [SliverGrid.count] and [SliverGrid.extent] respectively.
///
/// The [padding] property corresponds to having a [SliverPadding] in the
